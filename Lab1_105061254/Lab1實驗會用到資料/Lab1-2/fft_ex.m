...
fc = 100; % in MHz %the source wave frequency
fs = 80; % in MHz %the sampling frequency
Ncycle = 20; % number of cycles of sampled cosine
dt = 1/fs;  % time resolution
t_axis = (0:dt:Ncycle/fc);  % time axis
sampled_cos = sin(2*pi*fc*t_axis);  % sampled cosine ,time domain
...
xlabel('Time');
title('Sampled sine (time domain)');
